...
/**
 * EventBalladSearch represents the model behind the search form about `app\models\EventBallad`.
 */
class EventBalladSearch extends EventBallad
{
    /**
     * @inheritdoc
     */
